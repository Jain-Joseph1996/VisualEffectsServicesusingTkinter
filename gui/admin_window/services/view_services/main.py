...
class ViewServices(Frame):
    def __init__(self, parent, controller=None, *args, **kwargs):
        ...
        self.treeview.heading(list(self.columns.keys())[1], text="User ID")
        self.treeview.heading(list(self.columns.keys())[2], text="Check In")
        self.treeview.heading(list(self.columns.keys())[3], text="Service")
        self.treeview.heading(list(self.columns.keys())[4], text="Premium")
    ...
    def handle_delete(self):
        if db_controller.delete_service(self.parent.selected_rid):
