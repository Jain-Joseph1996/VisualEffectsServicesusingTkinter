...
from tkinter import (
    Frame, Canvas, Entry, StringVar, Text, Button, PhotoImage, messagebox,
)
    ...
    def save(self):
        ...
        if result:
            ...
            messagebox.showerror(
                "Error", "Unable to add user. Please make sure the data is validated"
            )
